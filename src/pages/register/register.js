...
import {Button, Row, Col, Input, Form, Upload, Modal, Select, Icon, message} from 'antd'
...
class Register extends React.Component{
  ...
  handleSubmit = (e)=>{
    ...
    this.props.form.validateFieldsAndScroll((err,values)=>{
      if(!err){
        console.log(values);
        this.props.register(values,this.state,values.avatar.file.name)
      }
    })
  }
        ...
        <Row>
          <Col span={12} offset={6}>
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              <Button type={"primary"} block style={{marginBottom:100}} htmlType={"submit"}>注册</Button>
            </Form>
